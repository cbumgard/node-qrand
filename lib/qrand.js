...
/**
 * num: number of hex octets to retrieve.
 * callback: passed two args: octet and count, where count is the current index.
 * callback is invoked for each new octet received.
 */
